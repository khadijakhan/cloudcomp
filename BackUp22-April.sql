...
INSERT  IGNORE INTO `goal` VALUES (1,'Availability','Anywhere/anytime/any device (desktop, laptop, and mobile) access to\r\nresources (e.g. CPU, storage, virtual machines, and network bandwidth) which\r\nare redundant and guarantee more availability (24/7/365 and 99.99%\r\navailability) compared to run in-house infrastructure. '),(2,'scalability','On the fly scaling up/ down resources and capability to provide varying\r\nresource demanding patterns.'),(3,'security','Providing secure services protected from unauthorized access by other tenants.'),(4,'performance','An excellent throughout speed and computations on cutting edge\r\ninfrastructure.'),(5,'customizability','Customisable and modifiable services upon requirements of consumers'),(6,'Interoperatibilty','Cloud services are integrable and incorporable with software systems as\r\nrequired.'),(7,'portability','Systems can move from one cloud to another cloud to get better offer (e.g.\r\nperformance, price, and security) with minimum disruption.'),(8,'testablity','Providing a scalable infrastructure to perform test and evaluation of highcomputational\r\ntasks.'),(9,'consistency','Guarantee of data consistency and not resulting in an error state for the system\r\nonce data are processing and changing in the cloud.'),(10,'reduced IT cost','Lower expense for infrastructure procuring, data storages, system updates,\r\nmaintenance, and staff.');
...
INSERT  IGNORE INTO `migration` VALUES (1,'Type 1','It offers discrete and reusable functionality, is deployed in cloud infrastructure through IaaS model such as Amazon EC2 but the data layer is kept in an on-premises network.'),(2,'Type 2','System components are replaced with fully tested cloud services using SaaS model.'),(3,'Type 3','The system database is deployed in a cloud data store provider such as Amazon Simple Storage Service (S3), Amazon Elastic Block Store, Dropbox, or Zip Cloud whilst business logic components are maintained on an on-premises network.'),(4,'Type 4','The database of a legacy is modified and converted to a cloud database solution such as Amazon SimpleDB, Google App Engine data store, or Google Cloud SQL.'),(5,'Type 5','The whole system stack is encapsulated in virtual machines and ran on servers.');
...
INSERT  IGNORE INTO `sgr` VALUES (1,2,1),(2,3,1),(3,4,1),(4,5,1),(5,35,1),(6,36,1),(7,37,1);
...
-- Dump completed on 2018-04-22 23:00:13
